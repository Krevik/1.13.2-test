...
public class BlockKathairisPortal extends BlockPortal
{
    ...
    public BlockKathairisPortal addToBlockRegistryList(){
   ...
   /* private IBlockState pickUpRandomFlowerState(Random random) {
    ...
    public BlockKathairisPortal.Size isPortal1(IWorld p_201816_1_, BlockPos p_201816_2_) {
        ...
        if (blockportal$size.isValid() && blockportal$size.portalBlockCount == 0) {
            ...
            BlockKathairisPortal.Size blockportal$size1 = new BlockKathairisPortal.Size(p_201816_1_, p_201816_2_, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper createPatternHelper(IWorld worldIn, BlockPos p_181089_2_) {
        ...
        if (!blockportal$size.isValid()) {
            ...
            blockportal$size = new BlockKathairisPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
