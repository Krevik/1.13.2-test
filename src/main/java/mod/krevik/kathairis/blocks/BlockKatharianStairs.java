...
public class BlockKatharianStairs extends BlockStairs implements IBucketPickupHandler, ILiquidContainer {
    ...
    protected static final VoxelShape AABB_SLAB_TOP = BlockKatharianSlab.TOP_SHAPE;
    protected static final VoxelShape AABB_SLAB_BOTTOM = BlockKatharianSlab.BOTTOM_SHAPE;
    ...
    public BlockKatharianStairs(String Name, IBlockState p_i48321_1_, Material material, float hardnessResistance, SoundType soundType) {
        super(p_i48321_1_,Block.Properties.create(material).sound(soundType).hardnessAndResistance(hardnessResistance));
    ...
    public static boolean isBlockStairs(IBlockState state) {
        return state.getBlock() instanceof net.minecraft.block.BlockStairs || state.getBlock() instanceof BlockKatharianStairs;
    }
