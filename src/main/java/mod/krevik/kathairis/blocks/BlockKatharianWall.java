...
public class BlockKatharianWall extends BlockWall {
    ...
    private boolean attachesTo(IBlockState p_196421_1_, BlockFaceShape p_196421_2_) {
        ...
        boolean flag = p_196421_2_ == BlockFaceShape.MIDDLE_POLE_THICK || p_196421_2_ == BlockFaceShape.MIDDLE_POLE && (block instanceof BlockFenceGate || block instanceof BlockKatharianFenceGate);
