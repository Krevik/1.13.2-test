...
public class BlockKatharianFourWay extends BaseBlock implements IBucketPickupHandler, ILiquidContainer {
    ...
    protected BlockKatharianFourWay(String Name, float p_i48420_1_, float p_i48420_2_, float p_i48420_3_, float p_i48420_4_, float p_i48420_5_, Block.Properties p_i48420_6_) {
        super(Name, p_i48420_6_, KathairisItemGroups.kathairis_building_blocks);
