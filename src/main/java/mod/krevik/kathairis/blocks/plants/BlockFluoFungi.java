...
import mod.krevik.kathairis.blocks.BlockKatharianLog;
...
public class BlockFluoFungi extends BlockKatharianPlant {
    ...
    public IBlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        if(isLog(world.getBlockState(pos.east()).getBlock())){
            return KBlocks.FLUO_FUNGI.getDefaultState().with(FACING,EnumFacing.WEST);
        }
        else if(isLog(world.getBlockState(pos.west()).getBlock())){
            return KBlocks.FLUO_FUNGI.getDefaultState().with(FACING,EnumFacing.EAST);
        }
        else if(isLog(world.getBlockState(pos.south()).getBlock())){
            return KBlocks.FLUO_FUNGI.getDefaultState().with(FACING,EnumFacing.NORTH);
        }
        else if(isLog(world.getBlockState(pos.north()).getBlock())){
            return KBlocks.FLUO_FUNGI.getDefaultState().with(FACING,EnumFacing.SOUTH);
        }else{
            return KBlocks.FLUO_FUNGI.getDefaultState().with(FACING,EnumFacing.WEST);
        }
    }
