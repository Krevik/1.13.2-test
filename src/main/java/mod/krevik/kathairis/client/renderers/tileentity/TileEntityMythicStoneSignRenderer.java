package mod.krevik.kathairis.client.renderers.tileentity;
...
{
    private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(KCore.MODID+":"+"textures/entity/sign.png");
    ...
    public void render(TileEntityMythicStoneSign te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == KCore.MythicStoneStandingSign)
        {
    ...
    {
        newBuffer.clear();
        newBuffer.put(p_74521_0_).put(p_74521_1_).put(p_74521_2_).put(p_74521_3_);
        newBuffer.flip();
        return newBuffer;
    }
}*/