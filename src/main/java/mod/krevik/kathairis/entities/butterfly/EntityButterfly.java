...
import mod.krevik.kathairis.blocks.plants.BlockButterflyFlower;
...
public class EntityButterfly extends EntityBasicButterfly
{
    ...
    {
        super(worldIn, KatharianEntityTypes.BASIC_BUTTERFLY1);
    ...
    protected void updateAITasks()
    {
        ...
        if(butterflyFlowerPos!=null) {
        	if(this.world.getBlockState(butterflyFlowerPos)== KBlocks.BUTTERFLY_FLOWER.getDefaultState().with(BlockButterflyFlower.VARIANT, BlockButterflyFlower.EnumType.WITH)) {
        ...
        if (this.getIsBirdSitting())
        {
            if (this.world.getBlockState(blockpos1).isNormalCube()||this.world.getBlockState(blockpos1)==KBlocks.BUTTERFLY_FLOWER.getDefaultState().with(BlockButterflyFlower.VARIANT, BlockButterflyFlower.EnumType.WITH))
            {
        ...
        else
        {
            ...
            if (this.rand.nextInt(100) == 0 && (this.world.getBlockState(blockpos1).isNormalCube()||this.world.getBlockState(blockpos1).getBlock()instanceof BlockKatharianPlant)||this.world.getBlockState(blockpos1)==KBlocks.BUTTERFLY_FLOWER.getDefaultState().with(BlockButterflyFlower.VARIANT, BlockButterflyFlower.EnumType.WITH))
            {
                this.setIsBirdSitting(true);
            }
