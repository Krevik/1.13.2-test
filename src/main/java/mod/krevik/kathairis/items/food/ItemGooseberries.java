...
public class ItemGooseberries extends ItemSeedFood {
    ...
    public ItemGooseberries(String Name, int p_i48473_1_, float p_i48473_2_, Block p_i48473_3_) {
    ...
    public EnumActionResult onItemUse(ItemUseContext context) {
        ...
        boolean canPlaceHere = KBlocks.GOOSEBERRY_BUSH.isValidPosition(iworld.getBlockState(blockpos),iworld,blockpos);
