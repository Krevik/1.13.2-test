...
public class ItemKathairisAxe extends ItemKathairisTool {
    ...
    protected ItemKathairisAxe(String Name,IItemTier tier, float p_i48530_2_, float attackSpeedIn, Item.Properties builder) {
        super(Name,p_i48530_2_, attackSpeedIn, tier, EFFECTIVE_ON, builder.addToolType(net.minecraftforge.common.ToolType.AXE, tier.getHarvestLevel()));
    }
