...
public class ItemKathairisPickaxe extends ItemKathairisTool {
    ...
    protected ItemKathairisPickaxe(String Name, IItemTier tier, int attackDamageIn, float attackSpeedIn, ItemGroup group) {
        super(Name,(float)attackDamageIn, attackSpeedIn, tier, EFFECTIVE_ON, new Item.Properties().group(group).addToolType(ToolType.PICKAXE,tier.getHarvestLevel()));
    }
