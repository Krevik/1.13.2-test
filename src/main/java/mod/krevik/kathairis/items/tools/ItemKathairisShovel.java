...
public class ItemKathairisShovel extends ItemKathairisTool {
    //TODO COMPLETE
    private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.CLAY, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL,
            Blocks.FARMLAND, Blocks.GRASS_BLOCK, Blocks.GRAVEL, Blocks.MYCELIUM, Blocks.SAND, Blocks.RED_SAND, Blocks.SNOW_BLOCK,
            Blocks.SNOW, Blocks.SOUL_SAND, Blocks.GRASS_PATH, Blocks.WHITE_CONCRETE_POWDER, Blocks.ORANGE_CONCRETE_POWDER,
            ...
            Blocks.RED_CONCRETE_POWDER, Blocks.BLACK_CONCRETE_POWDER, KBlocks.KATHARIAN_SAND, KBlocks.SOFT_SAND,
            KBlocks.KATHARIAN_DIRT, KBlocks.KATHARIAN_GRASS,KBlocks.MUD_BLOCK
            ,KBlocks.BLUE_CLOUD,KBlocks.BLUE_CLOUD_CONDENSED,KBlocks.YELLOW_CLOUD,KBlocks.YELLOW_CLOUD_CONDENSED,
            KBlocks.LAYERED_SAND);
