...
public class BiomeKatharianSoftSandLakes extends BiomeKatharianBiomeBase{
    public static final SurfaceBuilderConfig SAND_SAND_SANDSTONE_SURFACE = new SurfaceBuilderConfig(KBlocks.SOFT_SAND.getDefaultState(), KBlocks.SOFT_SAND.getDefaultState(), KBlocks.SOFT_SAND.getDefaultState());
