...
import mod.krevik.kathairis.world.dimension.feature.tree.AbstractKatharianTreeFeature;
...
public class FeatureKatharianForestBush extends AbstractKatharianTreeFeature {
    ...
    IBlockState LOG = KBlocks.SHINY_LOG.getDefaultState();
    IBlockState LEAVES = KBlocks.SHINY_LEAVES.getDefaultState();
    ...
    protected boolean place(Set<BlockPos> changedBlocks, IWorld worldIn, Random rand, BlockPos pos) {
        ...
        if(rand.nextInt(2)==0){
            LOG=KBlocks.MYSTIC_LOG.getDefaultState();
            LEAVES=KBlocks.MYSTIC_LEAVES.getDefaultState();
        }
