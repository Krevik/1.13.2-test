        ...
        for(int lvt_6_1_ = 0; lvt_6_1_ < 10; ++lvt_6_1_) {
            ...
            if (p_212245_1_.isAirBlock(lvt_7_1_)) {
                ...
                for(int lvt_9_1_ = 0; lvt_9_1_ < lvt_8_1_; ++lvt_9_1_) {
                    if (KBlocks.STEPPED_SUCCULENT.getDefaultState().isValidPosition(p_212245_1_, lvt_7_1_)) {
                        p_212245_1_.setBlockState(lvt_7_1_.up(lvt_9_1_), KBlocks.STEPPED_SUCCULENT.getDefaultState(), 2);
                    }
                }
            }
        }
